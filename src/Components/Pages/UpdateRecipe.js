...
const UpdateRecipe = () => {
    ...
    const SelectedImages = (
        <Flex display="block" height="200px">
            <Tag
                ...
                m="2"
            >
                <Box height="180px" width="200px">
                    <img height="180px" width="180px" src={recipeDetail.imageUrl} alt="product" />
                </Box>
                <TagCloseButton
                // onClick={() => removeImage(recipeDetail.imageUrl)} 
                />
            </Tag>
        </Flex>
    );
    ...
    return (
        <>
            <Box>
                <Text m="2" fontSize="lg" fontWeight="semibold">Update Recipe</Text>
                <Box
                    w="100%"
                    p="4"
                    borderWidth="thin"
